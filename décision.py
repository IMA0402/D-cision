...
"""
    ...
    sns.boxplot(x="النجاح_المعدل", y="الميزانية", data=df, palette="cool", ax=ax2)
    ...
    متوسط_ميزانية_النجاح = df[df["النجاح"] == "نجاح"]["الميزانية"].mean()
    متوسط_ميزانية_الفشل = df[df["النجاح"] == "فشل"]["الميزانية"].mean()
    st.markdown(f"""
